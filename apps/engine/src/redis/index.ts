import { LimitOrderSchema } from './../../../../packages/common/index';
import { prisma } from '@repo/db/client';
import { createClient } from "@redis/client";
import type { RedisClientType } from "redis";
import type { Market, SubscribeMessageType,OrderBookSystem } from '@repo/common';
import RedisSentinelMultiCommand from '@redis/client/dist/lib/sentinel/multi-commands';
...
export class Manager{
    ...
    createNewMarket(data: Extract<SubscribeMessageType, { type: "createMarket" }>){
